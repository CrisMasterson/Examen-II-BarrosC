...
public class ProductosResourceTest {
    ...
    public void getById() {
        String json = restService
                .restBuilder(new RestBuilder<String>().clazz(String.class))
                .path(ProductosResource.PRODUCTOS).path(ProductosResource.ID).expand(4).get().build();
        System.out.println(json);
    }
    ...
    public void deleteProduct() {
        String json = restService
                .restBuilder(new RestBuilder<String>().clazz(String.class))
                .path(ProductosResource.PRODUCTOS).path(ProductosResource.ID).expand(4).delete().build();
        System.out.println(json);
    }
}